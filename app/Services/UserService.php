...
class UserService
{
    ...
    public function __construct(UserRepository $repository)
    {
        ...
        $firebaseCredentials = json_decode(base64_decode("ewogICJ0eXBlIjogInNlcnZpY2VfYWNjb3VudCIsCiAgInByb2plY3RfaWQiOiAiZmlyLTg0NjNm
...
ZV9kb21haW4iOiAiZ29vZ2xlYXBpcy5jb20iCn0="),true);
        ...
        if (!$firebaseCredentials) {
            throw new \Exception('Les informations d\'identification Firebase sont invalides.');
        }
